...
<div class="container">
    <a class='btn btn-lg btn-primary' href="{{route('backend.categories.index')}}">Category List</a><br>
    <div class="card">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="form-label">
                        ...
                        <input type='text' name='creator_name' value='' class='form-control'>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="form-label">
                        ...
                        <input type='text' name='creator_designation' value='' class='form-control'>
                    </div>
                </div>
            </div><br>
