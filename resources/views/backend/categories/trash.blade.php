...
<div class="card">
    <div class="card-header">
        <a href="{{route('backend.categories.index')}}" class="btn btn-primary">Category Index Page</a>
        ...
        <table id="myDataTable" class="table table-bordered display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-sm btn-warning' href="{{route('backend.categories.restore',$category->id)}}">Restore</a>
                        <form action="{{ route('backend.categories.pdelete', $category->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
                            <button  id="bttn" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('backend.categories.pdelete', $category->id) }}')">Delete</button>
                        </form>
