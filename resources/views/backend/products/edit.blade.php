...
<style>
    ...
    <div class="card">
        <div class="card-header">
            <h3><b><center>Product Entry Form</center></b></h3>
        </div><br>
        <div class="card-body">
        <form action="{{route('backend.products.update', $product->id)}}" method='post' id="productForm">
            @csrf
            <div class="row">
                <div class="col-md-4">
            ...
            <button class="btn btn-lg btn-primary form-control" > Update Product</button>
        </form>
        </div>
    </div>
