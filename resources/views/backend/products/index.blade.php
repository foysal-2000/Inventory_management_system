...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{route('backend.products.trash')}}" class="btn btn-warning">Trash</a>
        ...
        <table id="myDataTable" class="table table-bordered display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-sm btn-primary' href="{{route('backend.products.show',$product->id)}}">Product Details</a>
                        <a class='btn btn-sm btn-warning' href="{{route('backend.products.edit', $product->id)}}">Edit</a>
                        <form action="{{ route('backend.products.delete', $product->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
                            <button  id="bttn" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('backend.products.delete', $product->id) }}')">Delete</button>
                        </form>
