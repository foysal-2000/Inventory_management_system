...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary mt-2">
        <!-- Container wrapper -->
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand mt-2 mt-lg-0" href="#">
                    ...
                    <img src="{{ asset('app/public/institute/' . $company->image) }}" alt="IMS" height="15"
                        loading="lazy" />
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="#">{{$company->branch_name}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">{{$company->branch_code}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">{{$company->address}}</a>
                    </li>
                    <li class="nav-item">
            ...
            <div  class="de mb-2">
                <ul class="ul" style="list-style: none; margin:2px;">
                    <li>
    ...
    <div class="content">
        <div class="row mt-2">
            <div class="col-md-8">
                <form action="{{ route('backend.inventory.searchProduct') }}" method="post" id="searchForm"
                    class="d-flex">
                    @csrf
            ...
            <div class="col-md-4">
                ...
                <a href="{{route('backend.productReturn.create')}}" class="btn btn-lg btn-primary"> Go To
                    Return-Product</a>
            </div>
            ...
            <div class="col-md-3">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="Returnamount" name="Returnamount" id="ReturnAmount" readonly>
                        </td>
                    </tr>
                    <tr>
