...
<div class="card">
    <div class="card-header">
        <a href="{{route('backend.inventory.index')}}" class="btn btn-primary">Go to index Page</a>
        ...
        <table id="myDataTable" class="table table-bordered display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-sm btn-warning' href="{{route('backend.inventory.restore', $inventory->id)}}">Restore</a>
                        <form action="{{ route('backend.inventory.pdelete', $inventory->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
                            <button  id="bttn" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('backend.inventory.pdelete', $inventory->id) }}')">Parmanently Delete</button>
                        </form>
