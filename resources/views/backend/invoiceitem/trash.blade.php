...
<div class="card">
    <div class="card-header">
        <a href="{{route('backend.invoiceitem.index')}}" class="btn btn-primary">Go to index</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('backend.invoiceitem.pdelete', $invoiceitem->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
                            <button  id="bttn" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('backend.invoiceitem.pdelete', $invoiceitem->id) }}')">Delete</button>
                        </form>
